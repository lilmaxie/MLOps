...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """
        This function reads the train and test data, applies the preprocessing pipeline, and saves the preprocessor object.
        It returns the transformed train and test data as numpy arrays.
        """
        try:
